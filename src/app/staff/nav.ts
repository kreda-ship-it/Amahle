...
const ITEMS: NavItem[] = [
  ...
  { label: "Take a booking", href: "/staff/book", built: false, permission: "appointment.create" },
  ...
  { label: "Services",  href: "/staff/services",  built: false, permission: "service.manage" },
